    ...
    , ui(new Ui::MainWindow)
{
    ...
    plotWindow->setCentralWidget(customPlot);
    plotWindow->resize(800, 600);

    connect(this, &MainWindow::dataReady, this, &MainWindow::plotData);
}
...
// Реализация слота для отрисовки графика
void MainWindow::plotData(QCustomPlot *customPlot, const QVector<double> &data)
{
    ...
    customPlot->yAxis->setRange(*std::min_element(data.begin(), data.end()), *std::max_element(data.begin(), data.end()));
    customPlot->replot();
}
...
void MainWindow::on_pb_start_clicked()
{
    ...
    auto findMax = [&](QVector<double> res){
                                                ...
                                                emit dataReady(customPlot, data);
                                             };
